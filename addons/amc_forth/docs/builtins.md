...
### <a name="DuckConvertIntToReal"></a>[DUCKINT2REAL](DuckConvertIntToReal.md)
...
### <a name="GetSpritePosition"></a>[GETSPRITEPOSITION](GetSpritePosition.md)
...
### <a name="GreaterThanOrEqual"></a>[&gt;=](GreaterThanOrEqual.md)
