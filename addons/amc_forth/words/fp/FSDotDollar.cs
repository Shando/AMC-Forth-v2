...
{
    [GlobalClass]
    public partial class FSDotDollar : Words
    {
        public FSDotDollar(AMCForth forth, string wordset)
            : base(forth, wordset)
        {
            Name = "FS.$";
            Description = "Saves the top number on the floating-point stack to the denoted string variable 'var$' using scientific notation:"
