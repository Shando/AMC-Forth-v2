    ...
    public partial class DuckRunQueryDollar : Words
    {
            ...
            : base(forth, wordset)
        {
            ...
            Description =
                ...
                + "The 'qry' must be a string variable.<br/>"
                ...
                + " FROM weather, cities WHERE cities.name = weather.city;<br/>"
                ...
                + "NOTE4: For Data Query Language commands, such as SELECT, 'u' will be the total number of results.<br/>"
