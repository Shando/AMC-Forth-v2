    ...
    public partial class LoadSprite : Words
    {
            ...
            : base(forth, wordset)
        {
            ...
            Description =
                ...
                + " for the player character, 0 for any character that can interact with the player character, -1 otherwise."
                ...
                + " Therefore a value of 0 will mean the SAME size as the sprite."
                + " NOTE: It is best practice to only use multiples that divide into the size of the sprite with no remainder."
