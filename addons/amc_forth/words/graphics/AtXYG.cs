...
namespace Forth.Graphics
{
    ...
    public partial class AtXYG : Words
    {
            ...
            : base(forth, wordset)
        {
            Name = "AT-XYG";
            Description =
                "Configure graphics display so next character displayed will appear at column 'x', row 'y' of the graphics display (origin in upper left)."
                + " NOTE: 'x' must be between 0 and 39 and 'y' must be between 0 and 23, as the default character size is 20 x 20 pixels."
